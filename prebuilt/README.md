...
| `fold3-fold-config.zip` | v6 | Fold states/postures/hinge RRO (cover selfie, Flex mode), auto-brightness, double tap to wake, Aperture lens overlay, Samsung hidden camera ids, outer-screen brightness |
| `fold3-fingerprint-fix.zip` | v3 | Re-sends `setActiveGroup` to Samsung's fingerprint HAL at boot and on HAL/rild restarts |
| `fold3-floss-ims.zip` | v18 | Floss IMS (VoLTE calls/SMS/MMS) built from `../floss-ims`, as a priv-app |
