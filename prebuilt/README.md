...
| `fold3-fold-config.zip` | v5 | Fold states/postures/hinge RRO (cover selfie, Flex mode), Aperture lens overlay, Samsung hidden camera ids, outer-screen brightness |
