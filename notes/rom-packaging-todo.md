...
- [ ] USB-C dock/desktop: write usb_sl from the framework (follow keyguard: SUNNY/CLOUDY), default the desktop-experience flags on, and handle the external display "mirror or extend" prompt properly
